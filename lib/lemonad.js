...
;(function() {
  ...
  L.curry1 = L.schonfinkel1 = _fix(L.curry, L._, 1);
  L.curry2 = L.schonfinkel2 = _fix(L.curry, L._, 2);
  L.curry3 = L.schonfinkel3 = _fix(L.curry, L._, 3);
  L.curry4 = L.schonfinkel4 = _fix(L.curry, L._, 4);

  // Curries a function of `n` parameters from right to left.
  L.rcurry1 = L.rschonfinkel  = _fix(L.rcurry, L._, 1);
  L.rcurry2 = L.rschonfinkel2 = _fix(L.rcurry, L._, 2);
  L.rcurry3 = L.rschonfinkel3 = _fix(L.rcurry, L._, 3);
  L.rcurry4 = L.rschonfinkel4 = _fix(L.rcurry, L._, 4);
