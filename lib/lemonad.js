...
;(function() {
  ...
  var _has = function(pred) {
    return function(coll) {
      for (var key in coll) {
        if (_existy(pred(coll[key]))) return coll[key];
      }
    };
  };
  ...
  */
  ...
  L.curry1 = L.schonfinkel1 = L(L.curry, L._, 1);
  L.curry2 = L.schonfinkel2 = L(L.curry, L._, 2);
  L.curry3 = L.schonfinkel3 = L(L.curry, L._, 3);
  L.curry4 = L.schonfinkel4 = L(L.curry, L._, 4);

  // Curries a function of `n` parameters from right to left.
  L.rcurry1 = L.rschonfinkel  = L(L.rcurry, L._, 1);
  L.rcurry2 = L.rschonfinkel2 = L(L.rcurry, L._, 2);
  L.rcurry3 = L.rschonfinkel3 = L(L.rcurry, L._, 3);
  L.rcurry4 = L.rschonfinkel4 = L(L.rcurry, L._, 4);
  ...
  L.rot = function(fun) {
    return function(/* args */) {
      var end = L.head(arguments);
      var more = L.tail(arguments);
      return fun.apply(fun, L.cat(more, end));
    };
  };
  ...
  var _destructiveMerge = function(target) {
    var mixes = _tail(arguments) || [];
  ...
  L.mix = function(target /*, mixins */) {
    ...
    if (_has(L.id)(args))
      _destructiveMerge.apply(null, _cons(target)(args));
