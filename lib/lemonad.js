...
(function() {
  ...
  L.addWatch    = L.funWrap(L.Watchable.watch);
  L.removeWatch = L.funWrap(L.Watchable.unwatch);
  ...
  _.extend(L.Ref.prototype,
           {setValue: function(newVal) {
              ...
              if (L.existy(validate))
                if (!validator(newVal))
                  throw "Attempted to set invalid value."
  ...
  L.setValue = L.funWrap(L.Ref.prototype.setValue);
  L.swap     = L.funWrap(L.Ref.prototype.swap);
  L.snapshot = L.funWrap(L.Ref.prototype.snapshot);
  ...
  L.compareAndSet = L.funWrap(L.CAS.prototype.compareAndSet);
